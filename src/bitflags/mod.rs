...
/// internal struct. This can be excluded by setting `bitflags_no_debug` feature
/// in the crate depending on bitflags.
///
/// ## Operators
///
...
//     #[test]
//     #[cfg_attr(feature = "ndebug", should_panic)]
//     fn test_debug() {
